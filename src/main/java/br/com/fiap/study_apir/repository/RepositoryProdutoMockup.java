...
public class RepositoryProdutoMockup {
    ...
    public RepositoryProdutoMockup() {
        produtos.add(new Produto(ID++, "Kiwi",
                BigDecimal.valueOf(10.50))); // new operador que instancia(cria) um objeto na memória (em um endereco)

        produtos.add(new Produto(ID++, "Pitaya",
                BigDecimal.valueOf(15.99))); // produto recebe o endereço do objeto / add -> a lista recebe endereço de
                                             // memoria
    }
